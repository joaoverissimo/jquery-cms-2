...
//Lista os dados
$where = '';
//$where = new dataFilter(dbBanner3i::_cod, 0, dataFilter::op_different);

$dados = dbBanner3i::ObjsList($Conexao, $where, 'ordem asc');
?><!DOCTYPE HTML>
<html>
    <head>
        <title>Ordem</title>
                    ...
                    <ul class="ordem">
                        <?php foreach ($dados as $obj) { ?>
                            ...
                            <li class="navbar-inner" id="listItem_<?php echo $obj->getCod(); ?>">
                                <span class="titulo"><span class="ativar<?php echo $obj->getExibir(); ?>"></span> <img src="<?php echo $obj->objImagem()->getSrc(30, 20);?>" /> <?php echo $obj->getTitulopt(); ?></span>
                            </li>
