...
<html lang="pt">
    ...
    <body>
        <h1>Solicitação de Recuperação de Senha <?php echo ___sisTitulo; ?></h1>
        <p>Olá <?php echo $obj->getNome(); ?>, como vai?</p>
        <p>Foi utilizado o recurso 'esqueci minha senha' do sistema <?php echo ___sisTitulo; ?>, a seguir seus dados de acesso:</p>
