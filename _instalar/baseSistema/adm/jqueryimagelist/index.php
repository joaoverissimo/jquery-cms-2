...
$where = '';
if ($filtraList) {
    //$where = new dataFilter(dbJqueryimagelist::_cod, 0, dataFilter::op_different);
    $where = new dataFilter(dbJqueryimagelist::_cod, $filtraList, dataFilter::op_likeMatches);
}

$orderBy = new dataOrder('jqueryimagelist.cod', 'desc');

$paginaAtual = 0;
if (isset($_REQUEST['page']))
    $paginaAtual = $_REQUEST['page'];

$pager = new dataPager($paginaAtual, 15, $Conexao, 'jqueryimagelist', $where);

$dados = dbJqueryimagelist::ObjsListLeft($Conexao, $where, $orderBy, $pager->getLimit());
...
<html>
    <head>
        <title><?php echo __('table_jqueryimagelist'); ?> - Listar</title>
        ...
        <div class="main">
            <div class="inner">
                <div class="page-header">
                    <h3><?php echo __('table_jqueryimagelist'); ?> <small>Listar</small></h3>
                </div>
                    ...
                    <table class="table table-hover table-striped" id="tablelista">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo __('jqueryimagelist.cod');?></th> 
                                <th><?php echo __('jqueryimagelist.info');?></th> 
                            ...
                            <tr>
                                ...
                                <td><?php echo $registro->getInfo(); ?></td>
