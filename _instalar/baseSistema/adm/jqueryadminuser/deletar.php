    ...
    if ($deletar) {
        try {
            ...
            if ($exec && $adm_tema != 'branco') {
                ...
                $msg = fEnd_MsgString("O registro foi excluido." . fEnd_closeTheIFrameImDone('jqueryadminuser', $registro->getCod()), 'success');
            }
...
$pageVars = array('pageTitle' => __('table_jqueryadminuser'), 'pageAction' => "Deletar", "nav-breadcrumbs" => array(__('table_jqueryadminuser') => "index.php"));
?><!doctype html>
