    ...
    if (issetArray($_POST['multi'])) {
        foreach ($_POST['multi'] as $cod) {
            try {
                ...
                $registro->Delete();
                $msg .= fEnd_MsgString("O registro #$cod foi excluido com sucesso." . fEnd_closeTheIFrameImDone('jqueryadminuser', $registro->getCod()), 'success');
...
$pageVars = array('pageTitle' => __('table_jqueryadminuser'), 'pageAction' => "Deletar Selecionados", "nav-breadcrumbs" => array(__('table_jqueryadminuser') => "index.php"));
?><!doctype html>
