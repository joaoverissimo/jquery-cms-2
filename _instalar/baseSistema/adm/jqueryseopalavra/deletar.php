    ...
    if ($deletar) {
        try {
            ...
            if ($exec && $adm_tema != 'branco') {
                ...
                $msg = fEnd_MsgString("O registro foi excluido." . fEnd_closeTheIFrameImDone('jqueryseopalavra', $registro->getCod()), 'success');
            }
        ...
        <div class="main">
            <div class="inner">
                <div class="page-header">
                    <h3><?php echo __('table_jqueryseopalavra'); ?> <small>Deletar</small></h3>
                </div>
