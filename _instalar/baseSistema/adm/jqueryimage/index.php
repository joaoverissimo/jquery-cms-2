...
$where = '';
if ($filtraList) {
    //$where = new dataFilter(dbJqueryimage::_cod, 0, dataFilter::op_different);
    $where = new dataFilter(dbJqueryimage::_valor, $filtraList, dataFilter::op_likeMatches);
}

$orderBy = new dataOrder('jqueryimage.cod', 'desc');

$paginaAtual = 0;
if (isset($_REQUEST['page']))
    $paginaAtual = $_REQUEST['page'];

$pager = new dataPager($paginaAtual, 15, $Conexao, 'jqueryimage', $where);

$dados = dbJqueryimage::ObjsListLeft($Conexao, $where, $orderBy, $pager->getLimit());
...
<html>
    <head>
        <title><?php echo __('table_jqueryimage'); ?> - Listar</title>
        ...
        <div class="main">
            <div class="inner">
                <div class="page-header">
                    <h3><?php echo __('table_jqueryimage'); ?> <small>Listar</small></h3>
                </div>
                    ...
                    <table class="table table-hover table-striped" id="tablelista">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo __('jqueryimage.cod');?></th> 
                                <th><?php echo __('jqueryimage.valor');?></th> 
                            ...
                            <tr>
                                ...
                                <td><?php echo $registro->getValor(); ?></td>
