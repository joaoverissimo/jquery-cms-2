    ...
    if ($deletar) {
        try {
            ...
            if ($exec && $adm_tema != 'branco') {
                ...
                $msg = fEnd_MsgString("O registro foi excluido." . fEnd_closeTheIFrameImDone('jqueryimage', $registro->getCod()), 'success');
            }
        ...
        <div class="main">
            <div class="inner">
                <div class="page-header">
                    <h3><?php echo __('table_jqueryimage'); ?> <small>Deletar</small></h3>
                </div>
