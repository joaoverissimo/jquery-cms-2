    ...
    if (issetArray($_POST['multi'])) {
        foreach ($_POST['multi'] as $cod) {
            try {
                ...
                $registro->Delete();
                $msg .= fEnd_MsgString("O registro #$cod foi excluido com sucesso." . fEnd_closeTheIFrameImDone('jqueryimage', $registro->getCod()), 'success');
...
<html>
    <head>
        <title><?php echo __('table_jqueryimage'); ?> - Deletar</title>
        ...
        <div class="main">
            <div class="inner">
                <div class="page-header">
                    <h3><?php echo __('table_jqueryimage'); ?> <small>Deletar Selecionados</small></h3>
                </div>
