...
if (count($_POST) > 0) {
    ...
    try {
        $registro->setJqueryimage(dbJqueryimage::UpdateByFileImagems($Conexao, 'jqueryimage'));
...
<html>
    <head>
        <title><?php echo __('table_jqueryimagelistitem'); ?> - Editar</title>
